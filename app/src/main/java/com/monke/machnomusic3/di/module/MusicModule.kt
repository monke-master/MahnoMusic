...
import com.monke.machnomusic3.data.repository.PlaylistRepositoryImpl
...
abstract class MusicModule {
    ...
    @Binds
    abstract fun bindPlaylistRepository(repositoryImpl: PlaylistRepositoryImpl): PlaylistRepository
